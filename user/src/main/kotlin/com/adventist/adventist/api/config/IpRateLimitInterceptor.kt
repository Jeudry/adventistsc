...
import com.adventist.adventist.infra.rate_limiting.IpRateLimiter
import com.adventist.adventist.infra.rate_limiting.IpResolver
...
class IpRateLimitInterceptor(
    ...
    @param:Value("\${adventist.ip.rate-limit.apply-limit}")
